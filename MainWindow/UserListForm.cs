    ...
    public partial class UserListForm : Form
    {
        ...
        void PopulateUserList()
        {
            ...
            try
            {
                ...
                {
                    this.UserDataGrid.Rows.Add(DbAccess.Unsanitize(user.Id), DbAccess.Unsanitize(user.Email), user.RightsFlags);
                }
            }
        ...
        private void UserDataGrid_CellContentClick(object sender, DataGridViewCellEventArgs args)
        {
            ...
            var modifyDialog = new ModUserForm(CurrentUser, AllUsers.Where(u => u.Id == id).ToArray()[0]);
